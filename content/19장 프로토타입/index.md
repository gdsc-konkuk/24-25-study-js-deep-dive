...
이름과 주소 속성으로 표현된 객체(`object`)인 `person`을 다른 객체와 구별하여 인식할 수 있다. 이처럼 속성을 통해 여러 개의 값을 하나의 단위로 구성한 복합적인 자료구조를 객체라고 하며, 이러한 객체 집합의 통신으로 프로그램을 표현하려는 것이 객체지향 프로그래밍 패러다임이다.
...
![[Screenshot 2025-01-04 at 9.30.06 AM.png]]
...
함수객체 
![[Screenshot 2025-01-04 at 9.30.45 AM.png]]

일반객체

![[Screenshot 2025-01-04 at 9.31.00 AM.png]]
...
![[Screenshot 2025-01-04 at 9.31.15 AM.png]]

ES6 메서드(`prototype`프로퍼티 없음)  

![[Screenshot 2025-01-04 at 9.31.28 AM.png]]
...
![[Screenshot 2025-01-04 at 9.31.45 AM.png]]
...
※ [객체리터럴로 객체 생성](https://262.ecma-international.org/11.0/#sec-object-initializer-runtime-semantics-evaluation)

![[Screenshot 2025-01-04 at 9.31.59 AM.png]]
...
![[Screenshot 2025-01-04 at 12.16.06 AM.png]]
...
![[Screenshot 2025-01-04 at 9.32.09 AM.png]]
